...
if [ ${tmp_exit_code} -eq 0 ]; then
    echo "ppdiffusers/deploy/sd3 old inference success" >>"${log_dir}/ce_res.log"
else
    echo "ppdiffusers/deploy/sd3 old inference fail" >>"${log_dir}/ce_res.log"
fi
echo "*******ppdiffusers/deploy/sd3 old inference end***********"
...
exit_code=$(($exit_code + ${tmp_exit_code}))
if [ ${tmp_exit_code} -eq 0 ]; then
    echo "ppdiffusers/deploy/sd3 inference_multi old success" >>"${log_dir}/ce_res.log"
else
    echo "ppdiffusers/deploy/sd3 inference_multi old fail" >>"${log_dir}/ce_res.log"
fi
echo "*******ppdiffusers/deploy/sd3 inference_multi old end***********"
...
exit_code=$(($exit_code + ${tmp_exit_code}))
if [ ${tmp_exit_code} -eq 0 ]; then
    echo "ppdiffusers/deploy/sd3 new inference success" >>"${log_dir}/ce_res.log"
else
    echo "ppdiffusers/deploy/sd3 new inference fail" >>"${log_dir}/ce_res.log"
fi
echo "*******ppdiffusers/deploy/sd3 new inference end***********"
...
exit_code=$(($exit_code + ${tmp_exit_code}))
if [ ${tmp_exit_code} -eq 0 ]; then
    echo "ppdiffusers/deploy/sd3 inference_multi new success" >>"${log_dir}/ce_res.log"
else
    echo "ppdiffusers/deploy/sd3 inference_multi new fail" >>"${log_dir}/ce_res.log"
fi
