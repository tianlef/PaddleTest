...
model_name=mPLUG_Owl3
cd ${work_path}
case_name=infer
echo "******* ${model_name}_${case_name} begin***********"
(CUDA_VISIBLE_DEVICES=0 python paddlemix/examples/mPLUG_Owl3/run_inference.py --dtype "bfloat16") 2>&1 | tee ${log_dir}/${model_name}_${case_name}.log
