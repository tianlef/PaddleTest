...
python -u sdxl/test_sdxl_single_ckpt.py  \
    --checkpoint_path output/sdxl_cond999_8node_lr5e-7_denoising4step_diffusion1000_gan5e-3_guidance8_noinit_noode_backsim_scratch/time_1752838179_seed10/checkpoint_model_000000/model.pdmodel \
